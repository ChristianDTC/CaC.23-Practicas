...
do {
  acumulador++;
  sueldoMensual = parseFloat(prompt(`Ingrese el sueldo del ${acumulador}° mes`));
  sueldoAnual += sueldoMensual;
} while (sueldoMensual >= 0 && acumulador != 12);

mensaje = acumulador == 12 ? "anual" : "parcial";
document.write(`El sueldo ${mensaje} percibido es $${sueldoAnual.toFixed(2)}`);
